...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var chart8 = new ApexCharts(document.getElementById('chart-mis-movimientos'), {
            ...
            labels: ["Sep 23","Oct 23","Nov 23","Dic 23", "Ene 24", "Feb 24", "Mar 24", "Abr 24", "May 24","Jun 24","Jul 24","Ago 24"],
    ...
    document.addEventListener("DOMContentLoaded", function () {
      	window.ApexCharts && (new ApexCharts(document.getElementById('chart-mis-saldos'), {
      		...
      		series: [{
      			name: "Saldo Mensual",
      			data: [-49090.32,272258.29,345324.57,-164670.47, 194514.36, -13549.13, -209744.42, 34082.17, 105469.92, -365523.41, 1495864.45,2078248.48]
      		}],
      		tooltip: {
      			theme: 'dark'
      		},
