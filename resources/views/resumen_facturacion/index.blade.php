    ...
    init = function($) {
		...
		$tabla.MegaDatatable({
			...
			columnDefs: [
				...
				{ data: "total",      className: "text-primary text-end font-monospace"    },
				{ data: "acumulado",  className: "text-end text-nowrap font-monospace"    },
				{ data: "a",          className: "text-end text-nowrap font-monospace"    },
				{ data: "b",          className: "text-end text-nowrap font-monospace"    },
				{ data: "c",          className: "text-end text-nowrap font-monospace"    },
				{ data: "d",          className: "text-end text-nowrap font-monospace"    },
				{ data: "e",          className: "text-end text-nowrap font-monospace"    },
				{ data: "f",          className: "text-end text-nowrap font-monospace"    },
				{ data: "g",          className: "text-end text-nowrap font-monospace"    },
				{ data: "h",          className: "text-end text-nowrap font-monospace"    },
				{ data: "i",          className: "text-end text-nowrap font-monospace"    },
				{ data: "j",          className: "text-end text-nowrap font-monospace"    },
				{ data: "k",          className: "text-end text-nowrap font-monospace"    },
				{
    				data: "a",
