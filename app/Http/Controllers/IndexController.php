...
class IndexController extends Controller
{
    ...
    protected function getData()
    {
        ...
        $fila1 = new \stdClass();
        $fila1->name = 'Ingresos';
        $fila1->data = [1821176.70, 2002276.06, 2233713.92, 2240387.91, 1791078.01, 2326091.80, 1732821.63, 4273135.28, 5475971.65, 5142265.04, 4536801.39, 4918385.29 ];

        $fila2 = new \stdClass();
        $fila2->name = 'Gastos';
        $fila2->data = [1985847.17, 1807761.70, 2247263.05, 2450132.33, 1756995.84, 2220621.88, 2098345.04, 2777270.83, 3397723.17, 5247359.80, 3836395.84, 5601596.69 ];
