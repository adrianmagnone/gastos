...
class IndexController extends Controller
{
    ...
    protected function getData()
    {
        ...
        $fila1 = new \stdClass();
        $fila1->name = 'Ingresos';
        $fila1->data = [1037402.55,1374872.15,1494979.83,1821176.70, 2002276.06, 2233713.92, 2240387.91, 1791078.01, 2326091.80, 1732821.63, 4273135.28, 5475971.65];

        $fila2 = new \stdClass();
        $fila2->name = 'Gastos';
        $fila2->data = [1086492.87,1042813.86,1089855.26,1985847.17, 1807761.70, 2247263.05, 2450132.33, 1756995.84, 2220621.88, 2098345.04, 2777270.83, 3397723.17];
